...
const Iteminfo = ({ value }) => {
    const { _id,name, brandname, photo, price, rateing, cartypes } = value
    console.log(value)
    return (
        <div className="card card-side bg-base-100 shadow-teal-200 shadow-2xl p-4 flex flex-col md:flex-row">
            ...
            <div className="card-body">
                ...
                <p>Type: <span className="text-green-300 font-light">{cartypes}</span></p>
                <p>Rate: <span className="text-green-300 font-light">{rateing}</span></p>
                <div className=" space-x-3">
                    <button className="text-green-300 btn shadow-lg shadow-green-300">Details</button>
                    <button className="text-orange-300-300 btn shadow-lg shadow-orange-300">Update</button>
                </div>
            </div>
        </div>
    );
